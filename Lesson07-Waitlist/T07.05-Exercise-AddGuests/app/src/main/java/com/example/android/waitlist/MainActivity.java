...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            Integer.parseInt(mNewPartySizeEditText.getText().toString());
        } catch (Exception e) {
    ...
    // TODO (6) call put to insert the name value with the key COLUMN_GUEST_NAME
        values.put(WaitlistEntry.COLUMN_GUEST_NAME, mNewGuestNameEditText.getText().toString());

    // TODO (7) call put to insert the party size value with the key COLUMN_PARTY_SIZE
        values.put(WaitlistEntry.COLUMN_PARTY_SIZE, mNewPartySizeEditText.getText().toString());
