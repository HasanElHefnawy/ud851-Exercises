...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (8) Inside, get the viewHolder's itemView's tag and store in a long variable id
                ...
                long id2 = mAdapter.getItemId(position);
                Log.e("zzzzz onSwiped", "id " + id + "\tposition " + position + "\tid2 " + id2);
    ...
    // TODO (2) Inside, call mDb.delete to pass in the TABLE_NAME and the condition that WaitlistEntry._ID equals id
        ...
        int numberOfRows = mDb.delete(WaitlistContract.WaitlistEntry.TABLE_NAME, WaitlistContract.WaitlistEntry._ID + " = ?", selectionArgs);
