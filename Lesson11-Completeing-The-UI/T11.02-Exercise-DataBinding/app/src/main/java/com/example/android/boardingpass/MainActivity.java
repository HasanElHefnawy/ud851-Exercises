...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long hoursOnlyUntilBoarding = TimeUnit.MINUTES.toHours(totalMinutesUntilBoarding);
        long minutesOnlyUntilBoarding = totalMinutesUntilBoarding - TimeUnit.HOURS.toMinutes(hoursOnlyUntilBoarding);
        String hoursAndMinutesUntilBoarding = getString(R.string.countDownFormat,
                hoursOnlyUntilBoarding,
                minutesOnlyUntilBoarding);
