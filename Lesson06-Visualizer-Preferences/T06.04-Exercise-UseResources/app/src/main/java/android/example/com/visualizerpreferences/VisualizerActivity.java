...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.key), Boolean.parseBoolean(getString(R.string.defaul_value))));
        mVisualizerView.setShowMid(getResources().getBoolean(R.bool.true_value));
        mVisualizerView.setShowTreble(getResources().getBoolean(R.bool.true_value));
