...
public class MainActivity extends AppCompatActivity implements TaskAdapter.ItemClickListener {
    ...
    private void retrieveTasks() {
        ...
        final Observer<List<TaskEntry>> nameObserver = new Observer<List<TaskEntry>>() {
            @Override
            public void onChanged(@Nullable final List<TaskEntry> tasks) {
                mAdapter.setTasks(tasks);
            }
        };
        tasks.observe(this, nameObserver);
    }
